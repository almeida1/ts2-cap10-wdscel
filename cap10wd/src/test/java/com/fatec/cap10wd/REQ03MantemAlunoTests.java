...
class REQ03MantemAlunoTests {
	...
	@BeforeEach
	public void setUp() {
		System.setProperty("webdriver.chrome.driver", "browserDrive/chromedriver.exe");
	...
	public void ct01_cadastrar_aluno_com_sucesso() {
		...
		espera();
		// ******************************************************************
		// quando o usuario cadastra um aluno com informações validas (não cadastrado)
		// ******************************************************************
